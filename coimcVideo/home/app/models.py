...
# ===================================================m zi tu对象=========================================
# M: m_zi_tu
class MBaseUrl(Model):
    __table__ = 'base_url'
    __autoCreate__ = AUTO_CREATE.get('BaseUrl', False)

    id = IntegerField(name='唯一主键', primary_key=True)
    enter_url = StringField(name='入口地址', ddl='varchar(500)')
    enter_url_bak = StringField(name='入口地址备用', ddl='varchar(500)')
...
class MIndex(Model):
    ...
    total = IntegerField(name='总页数')
    page_type = StringField(name='分类', ddl='varchar(255)')
...
class MPicture(Model):
    ...
    pic_order = IntegerField(name='图片序号')
    home_id = IntegerField(name='套图地址主键')
    home_url = StringField(name='所属套图地址', ddl='varchar(500)')
# ===================================================m zi tu对象结束=========================================


class TestTable(Model):
    __table__ = 'test'
    __autoCreate__ = AUTO_CREATE.get('TestTable', False)

    id = StringField(name='测试主键', primary_key=True)
    name = StringField(name='名称', ddl='varchar(255)')
    f = FloatField(name='测试Float')
